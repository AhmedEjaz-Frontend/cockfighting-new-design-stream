...
function Dashboard() {
  ...
  const url2 = "https://live.liv007.site/C01/whep";

  const initStream = async (url, videoRef, pcRef, setStatus) => {
    try {
  ...
  useEffect(() => {
    ...
    if (video1Ref.current && video2Ref.current) {
      initStream(url1, video1Ref, peerConnection1Ref, setConnectionStatus1);
      initStream(url2, video2Ref, peerConnection2Ref, setConnectionStatus2);
    }
              ...
              <div className="stream-wrapper">
                ...
                <div className="stream-overlay">
                  <div className="stream-header">
                    ...
                    <div className={`status-indicator ${connectionStatus1.toLowerCase()}`}>
              ...
              <div className="stream-wrapper">
                ...
                <div className="stream-overlay">
                  <div className="stream-header">
                    ...
                    <div className={`status-indicator ${connectionStatus2.toLowerCase()}`}>
                      <div className="status-dot"></div>
                      {connectionStatus2}
                    </div>
                  </div>
